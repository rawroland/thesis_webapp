...
<title>Distribution Manager | Debit Account</title>
					...
					<div class="panel-heading">
						<div class="row">
							...
							<div class="col-xs-9 text-right">
								<div class="huge">${client.account.ammount}</div>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-lg-6">
							<form:form action="debitAccount" modelAttribute="account"
								role="form">
								<form:hidden path="id" />
								<form:hidden path="clientId" />
								<div class="form-group">
									<label for="company"> Amount: </label>
									<form:input class="form-control" id="ammount" path="ammount"
										type="text" required="required" />
								</div>
								<button type="submit" name="debit" value="Debit Account"
									class="btn btn-default">Debit Account</button>
							</form:form>
						</div>
					</div>
				</div>
