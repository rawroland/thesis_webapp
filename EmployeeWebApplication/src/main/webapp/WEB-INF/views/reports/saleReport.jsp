...
<title>Distribution Manager | Generate Sales Report</title>
...
<body>
	...
	<div id="page-wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Generate Sales Report</h1>
			</div>
			<!-- /.col-lg-12 -->
		</div>
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-lg-6">
							<form:form action="report" modelAttribute="query" role="form">
								<div class="form-group">
									<label for="clients">Clients: </label>
									<form:select class="form-control" id="accounts" path="accounts"
										items="${accounts}" />
								</div>
								<div class="form-group">
									<label for="clients">Reporting Group: </label>
									<form:select class="form-control" id="reportingGroupId"
										path="reportingGroupId">
										<form:option value="0">Select Reporting Group</form:option>
								...
								<div class="form-group">
									...
									<div class="input-daterange input-group" id="datepicker">
										<form:input path="fromDate" class="input-sm form-control" />
										<span class="input-group-addon">to</span>
										<form:input path="toDate" class="input-sm form-control" />
									</div>
								</div>
								<form:hidden path="type" />
								<button type="submit" name="add" value="Generate Report"
									class="btn btn-default">Generate Report</button>
							</form:form>
						</div>
					</div>
				</div>
