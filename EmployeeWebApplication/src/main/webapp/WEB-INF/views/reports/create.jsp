...
<title>Distribution Manager | Create Reporting Group</title>
...
<body>
	...
	<div id="page-wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Create Reporting Group</h1>
			</div>
			<!-- /.col-lg-12 -->
		</div>
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">Reporting Group Information</div>
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-lg-6">
							<form:form action="createGroup" modelAttribute="reportingGroup"
								role="form">
								...
								<div class="form-group">
									...
									<form:select class="form-control" id="clients" path="clients">
										<c:forEach var="clientTypes" items="${clientsList}"
											varStatus="index">
											<optgroup label="${clientTypes.key}">
												<form:options items="${clientTypes.value}" />
											</optgroup>
										</c:forEach>
									</form:select>
								</div>
								<button type="submit" name="add" value="Create Reporting Group"
									class="btn btn-default">Create Reporting Group</button>
							</form:form>
						</div>
					</div>
				</div>
