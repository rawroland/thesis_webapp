...
<title>Distribution Manager | Save Transaction (Sale)</title>
...
<body>
	...
	<div id="page-wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Save Sale Transaction</h1>
			</div>
			<!-- /.col-lg-12 -->
		</div>
		<div class="col-lg-12">
					...
					<div class="row">
						<div class="col-lg-6">
							<form:form action="saveTransaction" modelAttribute="transaction"
								...
								<div class="form-group">
									<label for="accountId">Client: </label>
									<form:select class="form-control" id="accountId"
										path="accountId" items="${clientsList}" />
								</div>
								<div class="form-group">
								...
								<form:input type="hidden" value="sale" path="type" />
