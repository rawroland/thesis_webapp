...
<title>Distribution Manager|Edit Client</title>
		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-lg-6">
							<form:form action="editClient" modelAttribute="client"
								role="form">
								<form:hidden path="id" />
								...
								<button type="submit" name="edit" value="Edit Client"
									class="btn btn-default">Edit Client</button>
							</form:form>
						</div>
					</div>
				</div>
